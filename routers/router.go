...
func Init() *fiber.App {
	...
	app.Post("/api/dashboardwinlose", controller.DashboardComp_winlose)
	app.Post("/api/dashboardwinlosecompany", controller.DashboardComp_winlosecompany)
	app.Post("/api/dashboardlistcompany", controller.DashboardComp_listcompany)
	...
	app.Post("/api/savecompanyupdatepasaranroyaltyfee", controller.Companysaveupdatepasaranroyaltyfee)
	...
	app.Post("/api/invoicedetail", controller.Invoicedetail)
	app.Post("/api/saveinvoice", controller.Saveinvoice)
	app.Post("/api/saveinvoicewinlose", controller.Saveinvoicewinlose)
	app.Post("/api/saveinvoicewinlosepasaran", controller.Saveinvoicewinlosepasaran)
	app.Post("/api/deleteinvoicewinlosepasaran", controller.Deleteinvoicewinlosepasaran)
